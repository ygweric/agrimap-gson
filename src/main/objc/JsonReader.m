...
__attribute__((unused)) static NSString *ComGoogleGsonStreamJsonReader_locationString(ComGoogleGsonStreamJsonReader *self);
...
- (void)beginArray {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_BEGIN_ARRAY) {
    ...
    *IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1) = 0;
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected BEGIN_ARRAY but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
}
...
- (void)endArray {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_END_ARRAY) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected END_ARRAY but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
}
...
- (void)beginObject {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_BEGIN_OBJECT) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected BEGIN_OBJECT but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
}
...
- (void)endObject {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_END_OBJECT) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected END_OBJECT but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
}
...
- (NSString *)nextName {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_UNQUOTED_NAME) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a name but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
...
- (NSString *)nextString {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_UNQUOTED) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a string but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
  return result;
...
- (jboolean)nextBoolean {
  ...
  @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a boolean but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
}
...
- (void)nextNull {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NULL) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected null but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
}
...
- (jdouble)nextDouble {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a double but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  ...
  if (!lenient_ && (JavaLangDouble_isNaNWithDouble_(result) || JavaLangDouble_isInfiniteWithDouble_(result))) {
    @throw new_ComGoogleGsonStreamMalformedJsonException_initWithNSString_(JreStrcat("$D$", @"JSON forbids NaN and infinities: ", result, ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peekedString_ = nil;
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (jlong)nextLong {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a long but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_BUFFERED;
  jdouble asDouble = JavaLangDouble_parseDoubleWithNSString_(peekedString_);
  jlong result = JreFpToLong(asDouble);
  if (result != asDouble) {
    @throw new_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$$", @"Expected a long but was ", peekedString_, ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peekedString_ = nil;
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (jint)nextInt {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_LONG) {
    ...
    if (peekedLong_ != result) {
      @throw new_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$J$", @"Expected an int but was ", peekedLong_, ComGoogleGsonStreamJsonReader_locationString(self)));
    }
    peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
    (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
    return result;
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected an int but was ", [self peek], ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_BUFFERED;
  jdouble asDouble = JavaLangDouble_parseDoubleWithNSString_(peekedString_);
  result = JreFpToInt(asDouble);
  if (result != asDouble) {
    @throw new_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$$", @"Expected an int but was ", peekedString_, ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  peekedString_ = nil;
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (NSString *)description {
  return JreStrcat("$$", [[self getClass] getSimpleName], ComGoogleGsonStreamJsonReader_locationString(self));
}

- (NSString *)locationString {
  return ComGoogleGsonStreamJsonReader_locationString(self);
}
...
jint ComGoogleGsonStreamJsonReader_nextNonWhitespaceWithBoolean_(ComGoogleGsonStreamJsonReader *self, jboolean throwOnEof) {
  ...
  if (throwOnEof) {
    @throw new_JavaIoEOFException_initWithNSString_(JreStrcat("$$", @"End of input", ComGoogleGsonStreamJsonReader_locationString(self)));
  }
  else {
    return -1;
  }
...
NSString *ComGoogleGsonStreamJsonReader_locationString(ComGoogleGsonStreamJsonReader *self) {
...
jchar ComGoogleGsonStreamJsonReader_readEscapeCharacter(ComGoogleGsonStreamJsonReader *self) {
  ...
  jchar escaped = IOSCharArray_Get(nil_chk(self->buffer_), self->pos_++);
  {
    ...
    switch (escaped) {
      ...
      return escaped;
      default:
      @throw ComGoogleGsonStreamJsonReader_syntaxErrorWithNSString_(self, @"Invalid escape sequence");
    }
  }
}
...
JavaIoIOException *ComGoogleGsonStreamJsonReader_syntaxErrorWithNSString_(ComGoogleGsonStreamJsonReader *self, NSString *message) {
  @throw new_ComGoogleGsonStreamMalformedJsonException_initWithNSString_(JreStrcat("$$", message, ComGoogleGsonStreamJsonReader_locationString(self)));
}
...
- (void)promoteNameToValueWithComGoogleGsonStreamJsonReader:(ComGoogleGsonStreamJsonReader *)reader {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_DOUBLE_QUOTED_NAME) {
    ...
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$", @"Expected a name but was ", [reader peek], ComGoogleGsonStreamJsonReader_locationString(reader)));
  }
}
