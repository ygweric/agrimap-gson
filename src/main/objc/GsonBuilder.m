...
- (ComGoogleGsonGsonBuilder *)registerTypeHierarchyAdapterWithIOSClass:(IOSClass *)baseType
  ...
  if ([ComGoogleGsonJsonDeserializer_class_() isInstance:typeAdapter] || [ComGoogleGsonJsonSerializer_class_() isInstance:typeAdapter]) {
    [((id<JavaUtilList>) nil_chk(hierarchyFactories_)) addWithInt:0 withId:ComGoogleGsonInternalBindTreeTypeAdapter_newTypeHierarchyFactoryWithIOSClass_withId_(baseType, typeAdapter)];
  }
  if ([typeAdapter isKindOfClass:[ComGoogleGsonTypeAdapter class]]) {
...
void ComGoogleGsonGsonBuilder_addTypeAdaptersForDateWithNSString_withInt_withInt_withJavaUtilList_(ComGoogleGsonGsonBuilder *self, NSString *datePattern, jint dateStyle, jint timeStyle, id<JavaUtilList> factories) {
  ...
  [((id<JavaUtilList>) nil_chk(factories)) addWithId:ComGoogleGsonInternalBindTreeTypeAdapter_newFactoryWithComGoogleGsonReflectTypeToken_withId_(ComGoogleGsonReflectTypeToken_getWithIOSClass_(JavaUtilDate_class_()), dateTypeAdapter)];
  [factories addWithId:ComGoogleGsonInternalBindTreeTypeAdapter_newFactoryWithComGoogleGsonReflectTypeToken_withId_(ComGoogleGsonReflectTypeToken_getWithIOSClass_(JavaSqlTimestamp_class_()), dateTypeAdapter)];
  [factories addWithId:ComGoogleGsonInternalBindTreeTypeAdapter_newFactoryWithComGoogleGsonReflectTypeToken_withId_(ComGoogleGsonReflectTypeToken_getWithIOSClass_(JavaSqlDate_class_()), dateTypeAdapter)];
}
