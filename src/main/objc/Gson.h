...
#if !defined (ComGoogleGsonGson_) && (INCLUDE_ALL_Gson || defined(INCLUDE_ComGoogleGsonGson))
...
J2OBJC_STATIC_INIT(ComGoogleGsonGson)
...
#if !defined (ComGoogleGsonGson_FutureTypeAdapter_) && (INCLUDE_ALL_Gson || defined(INCLUDE_ComGoogleGsonGson_FutureTypeAdapter))
