...
- (jint)size {
  return [((ComGoogleGsonInternalLinkedTreeMap *) nil_chk(members_)) size];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleGsonJsonObject = { "JsonObject", "com.google.gson", ptrTable, methods, fields, 7, 0x11, 18, 1, -1, -1, -1, -1, -1 };
...
ComGoogleGsonJsonElement *ComGoogleGsonJsonObject_createJsonElementWithId_(ComGoogleGsonJsonObject *self, id value) {
  return value == nil ? JreLoadStatic(ComGoogleGsonJsonNull, INSTANCE) : (id) new_ComGoogleGsonJsonPrimitive_initWithId_(value);
}
