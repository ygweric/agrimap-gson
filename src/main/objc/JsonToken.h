...
//  source: /Users/eric/repos/360-j2objc/gson/build/mainTranslationExtraction/com/google/gson/stream/JsonToken.java
//
...
#if !defined (ComGoogleGsonStreamJsonToken_) && (INCLUDE_ALL_JsonToken || defined(INCLUDE_ComGoogleGsonStreamJsonToken))
